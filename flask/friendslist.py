from tkinter import Tk, Menu, Frame, Label, Entry, Button, Grid, BOTH

from pythontraining.flask.requester import Requester


class FriendsList(Tk):
    def __init__(self, **kwargs):
        ...
        self.menu = Menu(self, bg="lightgrey", fg="black", tearoff=0)

        self.friends_menu = Menu(self.menu, fg="black", bg="lightgrey", tearoff=0)
    ...
    def show_login_screen(self):
        ...
        real_name_label = Label(self.login_frame, text="Real Name")
        self.real_name_entry = Entry(self.login_frame)

        login_button = Button(self.login_frame, text="Login", command=self.login)
        create_account_button = Button(self.login_frame, text="Create Account", command=self.create_account)
        ...
        for i in range(3):
            Grid.rowconfigure(self.login_frame, i, weight=1)
            Grid.columnconfigure(self.login_frame, i, weight=1)
